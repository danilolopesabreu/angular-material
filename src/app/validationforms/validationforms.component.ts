...
export class ValidationFormsComponent {
  ...
  selectTheme = 'primary';
  cities = [
    {value: '0', viewValue: 'Pagamento de Cheque COMPE'},
    {value: '1', viewValue: 'Lançamento Retroativo'},
    {value: '2', viewValue: 'Cancelamento de Agendamento'},
    {value: '3', viewValue: 'Bloqueio e Desbloqueio'},
    {value: '4', viewValue: 'Manutenção de FE'},
    {value: '5', viewValue: 'Remanejamento de Contas/Pendências e Transferências de Contas'},
    {value: '6', viewValue: 'Estorno/Desfazimento'},
  ];
  ...
  ngOnInit() {
      this.register = this.formBuilder.group({
        ...
        descricaoLancamento: ['', Validators.required],
